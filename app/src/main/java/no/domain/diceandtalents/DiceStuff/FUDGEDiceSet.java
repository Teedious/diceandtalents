...
public class FUDGEDiceSet extends DiceSet {
	public static final int FUDGE_DICE_COUNT = 4;
	public static final int FUDGE_DICE_SIDES = 3;

	public FUDGEDiceSet() {
		count = FUDGE_DICE_COUNT;
		sides = FUDGE_DICE_SIDES; // The purist in me wants 6, but there's no good reason to.
		modifier = 0;
	}
